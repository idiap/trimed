...
/*The functions below:
 * - would be the same if blas were used (not as low level as l0), sqrting,
 * gramm matrices etc.
...
inline void set_l2(const TInt &dimension, const TFloat *const a,
                   const TFloat *const b, const TFloat &a_l22,
                   const TFloat &b_l22, TFloat &l2) {
  set_l22(dimension, a, b, a_l22, b_l22, l2);
  l2 = std::sqrt(std::max(static_cast<TFloat>(0), l2));
}

template <typename TInt, typename TFloat>
inline void set_l2(TInt dimension, const TFloat *const a, const TFloat *const b,
                   const TFloat &a_l22, const TFloat &b_l22, TFloat &l2,
                   TInt &ndcalcs) {
...
template <typename TInt, typename TFloat>
inline TFloat get_l2(const TInt &dimension, const TFloat *const a,
                     const TFloat *const b, const TFloat &a_l22,
                     const TFloat &b_l22) {
  TFloat l2;
  set_l2(dimension, a, b, a_l22, b_l22, l2);
...
inline TFloat get_l2(const TInt &dimension, const TFloat *const a,
                     const TFloat *const b, const TFloat &a_l22,
                     const TFloat &b_l22, TInt &ndcalcs) {
  ++ndcalcs;
 ...
 */
template <typename TInt, typename TFloat>
void set_rl2s(TInt ncols, const TFloat *const v, TInt nrows,
              const TFloat *const B, const TFloat &v_l22,
              const TFloat *const B_l22s, TFloat *const l2s) {
...
void set_rl2s(TInt ncols, const TFloat *const v, TInt nrows,
              const TFloat *const B, const TFloat &v_l22,
              const TFloat *const B_l22s, TFloat *const l2s, TInt &ndcalcs) {
...
template <typename TInt, typename TFloat>
void set_cl22s(TInt nrows, TInt ncols, const TFloat *const A,
               TFloat *const l22s) {
...
template <typename TInt, typename TFloat>
inline void set_l2s(TInt nrows, TInt ncols, const TFloat *const A,
                    TFloat *const l2s, bool byrow) {
...
template <typename TInt, typename TFloat>
void set_cl2s(TInt nrows, TInt ncols, const TFloat *const A,
              TFloat *const l2s) {
  set_l2s(nrows, ncols, A, l2s, false);
}

template <typename TInt, typename TFloat>
void set_rsums(TInt nrows, TInt ncols, const TFloat *const A,
               TFloat *const sums) {
  set_sums(nrows, ncols, A, sums, true);
}

template <typename TInt, typename TFloat>
void set_csums(TInt nrows, TInt ncols, const TFloat *const A,
               TFloat *const sums) {
  set_sums(nrows, ncols, A, sums, false);
}

template <typename TInt, typename TFloat>
std::unique_ptr<TFloat[]> getrsums(TInt nrows, TInt ncols,
                                   const TFloat *const A) {
...
template <typename TInt, typename TFloat>
void set_l2s(TInt nrows, TInt ncols, TFloat *const old_array,
             const TFloat *const new_array, TFloat *const l2s, bool byrow) {
...
template <typename TInt, typename TFloat>
void set_rl2s(TInt nrows, TInt ncols, TFloat *const old_array,
              const TFloat *const new_array, TFloat *const l2s) {
  set_l2s(nrows, ncols, old_array, new_array, l2s, true);
}

template <typename TInt, typename TFloat>
void set_cl2s(TInt nrows, TInt ncols, TFloat *const old_array,
              const TFloat *const new_array, TFloat *const l2s) {
  set_l2s(nrows, ncols, old_array, new_array, l2s, false);
}

template <typename TInt, typename TFloat>
void set_l2sconst(TInt nrows, TInt ncols, const TFloat *const array1,
                  const TFloat *const array2, TFloat *const l2s, bool byrow) {
...
template <typename TInt, typename TFloat>
void set_rl2sconst(TInt nrows, TInt ncols, const TFloat *const array1,
                   const TFloat *const array2, TFloat *const l2s) {
...
template <typename TInt, typename TFloat>
void set_cl2sconst(TInt nrows, TInt ncols, const TFloat *const array1,
                   const TFloat *const array2, TFloat *const l2s) {
...
template <typename TInt, typename TFloat>
void set_rrl22ss(TInt nrowsA, TInt ncols, const TFloat *const A, TInt nrowsB,
                 const TFloat *const B, TFloat *const l22ss) {
...
template <typename TInt, typename TFloat>
void set_rrl2ss(TInt nrowsA, TInt ncols, const TFloat *const A, TInt nrowsB,
                const TFloat *const B, TFloat *const l2ss) {
...
getrrl2ss(TInt nrowsA, TInt ncols, const TFloat *const A, TInt nrowsB,
          const TFloat *const B, const TFloat *const A_l22s,
          const TFloat *const B_l22s, TInt &n_distance_calculations) {
  std::unique_ptr<TFloat[]> rrl2ss(new TFloat[nrowsA * nrowsB]);
  set_rrl2ss(nrowsA, ncols, A, nrowsB, B, A_l22s, B_l22s, rrl2ss.get(),
...
template <typename TInt, typename TFloat>
void set_rrl22ss(TInt nrowsA, TInt nrowsB, TInt dimension,
                 const TFloat *const B, const TFloat *const A,
                 const TFloat *const B_l22s, const TFloat *const A_l22s,
                 TFloat *const l22ss) {
...
/* for back compatibility (order of parameters breaks personal rules) */
template <typename TInt, typename TFloat>
void set_rrl2ss(TInt nrowsA, TInt nrowsB, TInt dimension, const TFloat *const B,
                const TFloat *const A, const TFloat *const B_l22s,
                const TFloat *const A_l22s, TFloat *const l2ss) {
  set_rrl22ss(nrowsA, nrowsB, dimension, B, A, B_l22s, A_l22s, l2ss);
  for (TInt i = 0; i < nrowsA; ++i) {
    for (TInt j = 0; j < nrowsB; ++j) {
      l2ss[i * nrowsB + j] =
          std::sqrt(std::max(static_cast<TFloat>(0), l2ss[i * nrowsB + j]));
    }
  }
}
...
/* untested */
template <typename TInt, typename TFloat>
void set_l2gramm(TInt nrows, TInt dimension, const TFloat *const C,
  ...
  for (TInt cr = 0; cr < nrows; ++cr) {
    for (TInt cc = 0; cc < nrows; ++cc) {
      CC[cr * nrows + cc] =
          std::sqrt(std::max(static_cast<TFloat>(0), CC[cr * nrows + cc]));
    }
  }
}
...
template <typename TInt, typename TFloat>
void set_l2gramm(TInt nrows, TInt dimension, const TFloat *const C,
                 const TFloat *const C_l22s, TFloat *const CC, TInt &ndcalcs) {
  set_l2gramm(nrows, dimension, C, C_l22s, CC);
  ndcalcs += nrows * nrows;
}

/* set_ rows r1-> r2 of the gramm matrix of CC (note : CC is pointer to full
 * gramm matrix, variation of this may be needed, B?) */
template <typename TInt, typename TFloat>
void set_l2gramm_partial(TInt r1, TInt r2, TInt nrows, TInt dimension,
                         const TFloat *const C, const TFloat *const C_l22s,
                         TFloat *const CC, TInt &ndcalcs) {
  set_rrl22ss(r2 - r1, dimension, C + r1 * dimension, nrows, C, C_l22s + r1,
              C_l22s, CC + r1 * nrows);
  for (TInt i = 0; i < (r2 - r1) * nrows; ++i) {
    CC[r1 * nrows + i] =
        std::sqrt(std::max(static_cast<TFloat>(0), CC[r1 * nrows + i]));
  }
  ndcalcs += nrows * (r2 - r1);
}

template <typename TInt, typename TFloat>
std::unique_ptr<TFloat[]> get_rl22s(TInt nrows, TInt ncols,
                                    const TFloat *const A) {
...
template <typename TInt, typename TFloat>
std::unique_ptr<TFloat[]>
get_l2gramm(TInt nrows, TInt dimension, const TFloat *const C,
            const TFloat *const C_l22s, TInt &ndcalcs) {
  std::unique_ptr<TFloat[]> CC(new TFloat[nrows * nrows]); // Mr Meyers would
                                                           // disapprove for two
                                                           // reasons...
...
template <typename TInt, typename TFloat>
std::unique_ptr<TFloat[]> get_l2gramm(TInt nrows, TInt dimension,
                                      const TFloat *const C,
                                      const TFloat *const C_l22s) {
...
template <typename TInt, typename TFloat>
void set_rargmins(TInt nrowsA, TInt ncols, const TFloat *const A, TInt nrowsB,
                  const TFloat *const B, const TFloat *const A_l22s,
                  const TFloat *const B_l22s, TInt *const argmins) {
...
template <typename TInt, typename TFloat>
void set_rargminmins(TInt nrowsA, TInt ncols, const TFloat *const A,
                     TInt nrowsB, const TFloat *const B,
                     const TFloat *const A_l22s, const TFloat *const B_l22s,
...
void set_rargminmins(TInt nrowsA, TInt ncols, const TFloat *const A,
                     TInt nrowsB, const TFloat *const B,
                     const TFloat *const A_l22s, const TFloat *const B_l22s,
                     TInt *const argmins, TFloat *const mins, TInt &ndcalcs) {
